...
* DONE PRACTICE: META OR NOT META?
...
* DONE PROBLEM: VARIABLE DEFINITIONS
...
* DONE TYPES OF CATEGORICAL VARIABLES
...
* DONE PRACTICE: RAW VS. TRANSFORMED GRAPH DATA
...
* DONE R FOR EXPLORATORY ANALYSIS
...
* IN PROGRESS INSTALLATION AND LOADING R PACKAGES
...
* SOMEDAY OPTIONAL INSTALLATION IN THE RGUI
...
* DONE QUESTIONS TO ASK FROM DATA
...
* IN PROGRESS PRACTICE: A REPRESENTATIVE R SESSION
