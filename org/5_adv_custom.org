...
- Here: stacked barplots and tableplots
...
- ~yvec~ retrieves the positions of the center of each bar in the plot,
  ...
  labels
  #+begin_src R :results graphics file :file 5_yvec.png
    barplot(
      height=barLengths,
      col = colorVector)
#      horiz = TRUE)
...
** TODO Color options in R



** TODO Stacked barplots
** TODO The ~tableplot~ function
