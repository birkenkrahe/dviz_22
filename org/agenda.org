...
* NEXT Checking in: 2nd sprint review
#+attr_html: :width 500px
[[../img/sprint2.jpg]]
...
* Review: home assignment "Quick intro to base graphics"
...
1) Get the practice file [[https://tinyurl.com/mr27fyph][tinyurl.com/mr27fyph]] (GDrive)
2) Run the ~#+PROPERTY~ and ~#+STATUS~ header with ~C-c C-c~
3) Run the first code bloc: the data come from GDrive, too!
