...
* IN PROGRESS Week 14: Data visualization with Tableau
#+attr_html: :width 500px
[[../img/tableau.png]]
...
* IN PROGRESS Working with external data
#+attr_html: :width 400px
[[../img/rsqlite.png]]
...
- [ ] Data in relational databases (~sqldf~, ~RSQLite~)
* TODO Internet text mining example
#+attr_html: :width 400px
[[../img/penguin.jpg]]
...
* TODO Tableau review [DataCamp]
#+attr_html: :width 400px
[[../img/book.jpg]]


- Additional resources ([[https://lyon.instructure.com/courses/571/discussion_topics/1294][see Canvas announcement]]):
  1) [[https://www.datacamp.com/tutorial/creating-stories-tableau][Creating stories in Tableau]] (aka [[http://www.literateprogramming.com/][literate programming]])
  2) How to build engaging dashboards ([[https://drive.google.com/file/d/18ISvLVzA5nNjNUExkqd5_CxH0wfpUY-k/view?usp=share_link][whitepaper]] and [[https://www.datasciencecentral.com/dsc-webinar-seriesmaking-flow-happen-dashboards-that-persuade-inform-and-engage-10-29-2013/][video]])
  3) Tableau courses [[https://app.datacamp.com/search/?q=tableau&type=course][at DataCamp]] (limited access - 6 months)
...
* TODO Connecting R to relational databases



* Week 15: Spreadsheets & evaluation
#+attr_html: :width 500px
[[../img/sheets.jpg]]
