...
- [ ] Practice: scatterplots & barcharts & customization
...
* TODO Review: Visualizing two variables
* Example: Nile
...
* IN PROGRESS Extended EDA example in R  
* NEXT Exploratory vs. explanatory graphics in R
* References
