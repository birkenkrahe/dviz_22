...
* Week 13: Summarizing numerical data
#+attr_html: :width 500px
[[../img/shiny.png]]

- [ ] New test available [[https://lyon.instructure.com/courses/571/assignments/3570?display=full_width][in Canvas]] - do it!
- [ ] Easter egg: what do the paintings have in common?
  - Goya, The Clothed Maja
  - Da Vinci, The Last Supper
  - van Gogh, Sunflowers 
  - Botticelli, La Primvera
- [ ] RStudio demo and practice
- [ ] R ~shiny~ review [DC]
- [ ] EDA: Variable types
- [ ] EDA: The Gaussian assumption
- [ ] EDA: Anomalies in numerical data

* EDA: Summarizing numerical data (RStudio demo)
