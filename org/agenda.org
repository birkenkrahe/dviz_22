...
- [ ] Added [[https://github.com/birkenkrahe/dviz/blob/piHome/org/3_graphics.org#grid-graphics-example][grid package example]] to lecture
- [ ] Adding details to plots
...
* TODO WEDNESDAY - Practice: adding details to ~plot~
