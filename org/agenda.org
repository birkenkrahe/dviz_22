...
* IN PROGRESS Week 3: graphics in R
#+attr_html: :width 400px
[[../img/graphics.png]]

 - [ ] [[file:~/Documents/R/dviz/2_data_eda_R_practice.org][Complete practice file]]
 - [ ] DataCamp lesson: [[https://app.datacamp.com/learn/courses/data-visualization-for-everyone][visualizing distributions]] (by Aug 26)
...
* IN PROGRESS Practice: extended R EDA example
