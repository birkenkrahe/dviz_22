...
* TODO (Wed) Review test 6: base R parameters and ~plot~

1) Which function controls graphic parameters for plots in R?

2) How can you create a panel of four plots?

3) How do you turn a scatterplot ~plot(x,y)~ into a line plot?

4) Can every scatterplot be turned into a meaningful line plot?
...
5) What's the most important deliverable of your 2nd sprint review?
   
6) What do you get when plotting factor levels with ~plot~?
   #+begin_src R :results graphics file :file ../q62.png
     par(mfrow=c(1,1))
     plot(ToothGrowth$supp)
   #+end_src

7) What's the difference between ~plot(Nile, type="l")~ and ~plot(Nile)~?
...
8) When could you consider using ggplot2 instead of base R?
   #+begin_quote
...
9) What are the default values of ~mfrow~ and ~col~?
   #+begin_src R
     par()$mfrow
   #+end_src

10) ~y~ is a vector of 10 random numbers. What's the difference between
    ~which( y > 0)~ and ~(y > 0)~ ?
    #+begin_src R
      y <- rnorm(10)
      y
...
* TODO Adding details to plots (cont'd)
#+attr_html: :width 500px

[[../img/details.jpg]]

- The basis of this section is [[https://github.com/birkenkrahe/dviz/blob/piHome/org/4_plot.org][this lecture on GitHub]]
- The customized file so far: https://tinyurl.com/mrx3txen
- Submit completed practice file [[https://lyon.instructure.com/courses/571/assignments/2990][to Canvas]]
  
* TODO (Fri) - Practice: adding details to ~plot~
...
* Week 9: Different plot types
* Week 10: Advanced plot customization
* Week 11-15: ggplot2, Shiny, Tableau, projects
* References
#+attr_html: :width 500px
[[../img/books.jpg]]
