...
- [ ] Review assignment 7 (solutions in GitHub / [[https://lyon.instructure.com/courses/571/assignments/1656][Canvas]])
- [ ] Finish basic graphics (~layout~ and color)
- [ ] Complete test 7 (customizing base R plots / [[https://lyon.instructure.com/courses/571/assignments/3275/edit?quiz_lti][Canvas]])
...
Set of exercises based on Pearson's archived DataCamp course (ch 1):
#+begin_quote
"This chapter introduces several Base R supported plot types that are
...
1) What do the data in these four plots have in common, and what is
   ...
   - Histogram: x = values in fixed bins, y = counts
