...
- [ ] Review: ~ggplot2~ [DataCamp] - practice file: 
- [ ] New assignment: data visualization in spreadsheets [DataCamp]
...
- Download the review practice file
- Open the file in GitHub
- Upload the completed file to Canvas
