...
- [ ] Learn how to print plots directly from code 
- [ ] Finish basic graphics (~mfrow~, ~layout~ and color)
- [ ] @Home: complete test 7 (customizing base R plots / [[https://lyon.instructure.com/courses/571/assignments/3275/edit?quiz_lti][Canvas]])
...
4) What's the index vector for the last question? 
   ...
   #+RESULTS:
   :  [1] 963 813 995 935 994 960 958 840 874 940 833 916 969 831 824 832 821 845 864
   : [20] 862 845 865 845 944 984 897 822 846 812 801 860 874 848 890 838 918 986 923
   : [39] 975 815 906 901 912 919
   : png 
   :   2
