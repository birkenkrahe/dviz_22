...
* Week 8: Layout, symbols and plot arrays
#+attr_html: :width 500px
[[../img/week8.jpg]]
...
* READ Review: assignment "Quick intro to base graphics"
...
* TODO Next home assignment: Single variable plots
#+attr_html: :width 400px
[[../img/geyser.png]]
...
#+end_notes
* TODO Scatterplot customization part II
...
- [ ] Open the practice file [[https://raw.githubusercontent.com/birkenkrahe/dviz/piHome/org/plotpractice.org][from GitHub]] in your browser at
...
- [ ] In ~custom2.org~ insert the ~txt~ file you downloaded with ~C-x i~
  followed by the file name (type ~TAB~ to see available files)

- [ ] Run *each* header line in ~custom2.org~ to activate it, then go to
  the first code block in the ~Getting the data~ section and run it to
  get the data set from the web via URL.
  #+attr_html: :width 400px
  [[../img/df.png]]

- [ ] Run the block in ~Plotting the data~ to get the coordinate vectors
  ~x~ and ~y~:
  #+attr_html: :width 400px
  [[../img/coordinates.png]]

- [ ] Collapse all headings with ~SHIFT-TAB~ (toggles)

- [ ] Go to the heading ~Customize the plot~ and run the second (2) code
  block to generated the file ~final.png~
  #+attr_html: :width 400px
  [[../img/final.png]]

- [ ] Save the file ~custom2.org~ with ~C-x C-s~

- [ ] Complete the sections ~Add a trendline~, ~Add text for outliers~,
  and ~Add a legend~ using ~4_plot.org~ in GitHub: [[https://tinyurl.com/5etspdyr][tinyurl.com/5etspdyr]]

- [ ] Upload your completed Org-mode file in Canvas ([[https://lyon.instructure.com/courses/571/assignments/3201][Practice 6]])

- [ ] Solutions will be available as PDF from Wednesday

* TODO Wed Layout, symbols and plot arrays
* TODO Fri review: assignment (single variable plots)

Review of assignment derived from Pearson's archived course ([[https://lyon.instructure.com/courses/571/assignments/1656][Canvas]])

* Week 9-10: Different plot types, external data
** IN PROGRESS Assignment 7. [[https://app.datacamp.com/learn/courses/data-visualization-in-r][Different plot types]] ([[https://lyon.instructure.com/courses/571/assignments/1656][Canvas]])
DEADLINE: <2022-10-19 Wed 15:00>

Set of exercises based on Pearson's archived DataCamp course: "This
chapter introduces several Base R supported plot types that are
particularly useful for visualizing important features in a
dataset. We start with simple tools like histograms and density plots
for characterizing one variable at a time, move on to scatter plots
and other useful tools for showing how two variables relate, and
finally introduce some tools for visualizing more complex
relationships in our dataset."
** TODO Test 7

** TODO Assignment 8. External data ([[https://lyon.instructure.com/courses/571/assignments/1673][Canvas]])
** TODO Test 8
* Week 11-13: ggplot2, Shiny, Tableau
** TODO Assignment 9. [[https://app.datacamp.com/learn/courses/introduction-to-data-visualization-with-ggplot2][Introduction to ggplot2]] ([[https://lyon.instructure.com/courses/571/assignments/1667][Canvas]])

Go to your assignments dashboard in DataCamp and complete the *first*
chapter of the course "[[https://app.datacamp.com/learn/courses/introduction-to-data-visualization-with-ggplot2][Introduction to Data Visualization with
ggplot2]]". ggplot2 is one of the most popular graphics packages in
R. It is also practically and conceptually more complex than base R
graphics. It is commonly bundled with the "Tidyverse" distribution
though it predates this distribution by a number of years.

"In this chapter we’ll get you into the right frame of mind for
developing meaningful visualizations with R. You’ll understand that as
a communications tool, visualizations require you to think about your
audience first. You’ll also be introduced to the basics of ggplot2 -
the 7 different grammatical elements (layers) and aesthetic mappings."

*Note:* If you already did it for one of the other courses, you don't
have to re-do the assignment.
** TODO Test 9
** TODO Assignment 10. [[https://campus.datacamp.com/courses/building-web-applications-with-shiny-in-r/get-started-with-shiny?ex=1][Building Web Applications with Shiny in R [DC]​]] ([[https://lyon.instructure.com/courses/571/assignments/1654][Canvas]])

Go to your assignments dashboard in DataCamp and complete the *first*
chapter of the course "[[https://campus.datacamp.com/courses/building-web-applications-with-shiny-in-r/get-started-with-shiny?ex=1][Building Web Applications with Shiny in R]]". R
Shiny is an R package that makes it easy to build interactive web apps
and dashboards directly in R.

*** Video: Introduction to Shiny
** TODO Test 10
** TODO Assignment 11. [[https://campus.datacamp.com/courses/introduction-to-tableau/getting-started-with-tableau?ex=1][Getting started with Tableau​]] ([[https://lyon.instructure.com/courses/571/assignments/1668][Canvas]])

Go to your assignments dashboard in DataCamp and complete the *first*
chapter of the course "[[https://app.datacamp.com/learn/courses/introduction-to-tableau][Introduction to Tableau]]". Tableau is a widely
used business intelligence (BI) and analytics software based largely
on SQL queries.

"You will get an understanding of Tableau's fundamental concepts and
features: how to connect to data sources, use Tableau’s drag-and-drop
interface, and create compelling visualizations. You will be explore
an Airbnb dataset for the city of Amsterdam."

As part of the academic alliance with DataCamp, you have access to all
Tableau courses until the end of term (usually, all lessons except the
first are only accessible to enterprise clients).
* Week 14-15: projects, final exam
* References
#+attr_html: :width 500px
[[../img/books.jpg]]
