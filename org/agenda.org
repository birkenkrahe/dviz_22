...
* Week 13: RStudio, data storytelling
#+attr_html: :width 600px
[[../img/shiny.png]]
...
- [ ] EDA: Variable types / Gaussian assumption / anomalies
- [ ] Rendering HTML pages from Emacs Org-mode files

* DONE EDA: Summarizing numerical data (Notebook demo)
#+attr_html: :width 500px
[[../img/workspace.png]]
...
* DONE Rendering HTML pages from Emacs Org-mode
...
* DONE Comments: 3rd sprint review (abstract/results)
#+attr_html: :width 400px
[[../img/nanny.png]]
...
6) Building a simple EDA app with R Shiny
