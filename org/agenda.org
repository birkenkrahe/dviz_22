...
- Scatterplot of ~brain~ vs ~body~ of the ~mammals~ data set in ggplot2
  #+begin_src R :results graphics file :file ../img/mammalsgg.png
    library(ggplot2)
  ...
  #+RESULTS:
  [[file:../img/mammalsgg.png]]
  
- Scatterplot of ~brain~ vs ~body~ of the ~mammals~ data set in base R
  #+begin_src R :results graphics file :file ../img/mammals.png
    plot(mammals)
  #+end_src

  #+RESULTS:
  [[file:../img/mammals.png]]

- Scatterplot with logarithmically transformed data in ggplot2
  #+begin_src R :results graphics file :file ../img/mammalsloggg.png
    ggplot(mammals, aes(x=body,y=brain)) +
  ...
  #+RESULTS:
  [[file:../img/mammalsloggg.png]]

- Scatterplot with logarithmically transformed data in base R
  #+begin_src R :results graphics file :file ../img/mammalslog.png
      plot(log10(mammals))
  #+end_src

  #+RESULTS:
  [[file:../img/mammalslog.png]]

- Trendline in logarithmically transformed model in ggplot2
  #+begin_src R :results graphics file :file ../img/mammals1gg.png
    ggplot(mammals, aes(x=body,y=brain)) +
      geom_point(alpha = 0.6) +
      coord_fixed() +
      scale_x_log10() +
  ...
  #+RESULTS:
  [[file:../img/mammals1gg.png]]
  
- Trendline in logarithmically transformed model in base R
   #+begin_src R :results graphics file :file ../img/mammals1.png
     plot(log10(mammals))
     abline(
       lm(brain ~ body, data=log10(mammals)),
       col="red", lwd=2)
    #+end_src
...
- Fancy version of scatterplot with original/log10 data in base R:
  #+begin_src R :results graphics file :file ../img/mammals_fancy.png
    par(mfrow=c(1,2),pty='s')
    plot(
      mammals,
      main="Original data (mammals)",
      las=1)
    plot(
      log10(mammals),
      xlab="log10(body)",
      ylab="log10(brain)",
      main="Log data (mammals)",
      las=1)
  #+end_src

  #+RESULTS:
  [[file:../img/mammals_fancy.png]]

- Fancy version of linear model of ~brain~ vs ~body~ of the ~mammals~ data
  set in base R
  #+begin_src R :results graphics file :file ../img/mammals1_fancy.png
    par(mfrow=c(1,1))
    plot(
      log10(mammals),
        xlab="log10(body)",
      ylab="log10(brain)",
        main="Log-transformed data (mammals)",
        las=1)
    abline(
      lm(brain ~ body, data=log10(mammals)),
      col="red", lwd=2, lty=3)
