...
- Class session schedule  
  #+name: tab:schedule
  | NO | DATE       | TESTS      | TEXTBOOK           | ASSIGNMENT[fn:1]                   |
  |----+------------+------------+--------------------+------------------------------------|
  |  1 | Wed-17-Aug | Entry Test |                    | 1. Visualizing distributions [DC]  |
  |  2 | Fri-19-Aug |            |                    | 2. Emacs tutorial                  |
  |----+------------+------------+--------------------+------------------------------------|
  |  3 | Mon-22-Aug | Test 1     | 1. Data, EDA, R    | 3. Visualizing two variables [DC]  |
  |  4 | Wed-24-Aug |            |                    |                                    |
  |  5 | Fri-26-Aug |            |                    |                                    |
  |----+------------+------------+--------------------+------------------------------------|
  |  6 | Mon-29-Aug | Test 2     | 2. Graphics in R   | 4. The color and the shape [DC]    |
  |  7 | Wed-31-Aug |            |                    |                                    |
  |  8 | Fri-02-Sep |            |                    | 1st Sprint review                  |
  |----+------------+------------+--------------------+------------------------------------|
  |  9 | Wed-07-Sep | Test 3     | 2.3 plot()         | 5. 99 problems... [DC]             |
  | 10 | Fri-09-Sep |            |                    |                                    |
  |----+------------+------------+--------------------+------------------------------------|
  | 11 | Mon-12-Sep | Test 4     | 2.4 Adding details | 6. Intro to base R graphics [DC]   |
  | 12 | Wed-14-Sep |            |                    |                                    |
  | 13 | Fri-16-Sep |            |                    |                                    |
  |----+------------+------------+--------------------+------------------------------------|
  | 14 | Mon-19-Sep | Test 5     | 2.5 Plot types     | 7. Different plot types [DC]       |
  | 15 | Wed-21-Sep |            |                    |                                    |
  | 16 | Fri-23-Sep |            |                    |                                    |
  |----+------------+------------+--------------------+------------------------------------|
  | 17 | Mon-26-Sep | Test 6     | 2.6 Plot arrays    | 8. Adding details to plots [DC]    |
  | 18 | Wed-28-Sep |            |                    |                                    |
  | 19 | Fri-30-Sep |            |                    | 2nd Sprint Review                  |
  |----+------------+------------+--------------------+------------------------------------|
  | 20 | Wed-05-Oct | Test 7     | 2.7 Color graphics | 9. How much is too much? [DC]      |
  | 21 | Fri-07-Oct |            |                    |                                    |
  |----+------------+------------+--------------------+------------------------------------|
  | 22 | Mon-10-Oct | Test 8     | 3.1 Exploring data | 10. Adv plot customization [DC]    |
  | 23 | Wed-12-Oct |            |                    |                                    |
  | 24 | Fri-14-Oct |            |                    |                                    |
  |----+------------+------------+--------------------+------------------------------------|
  | 25 | Mon-24-Oct | Test 9     | 3.2 Numerical data | 11. Intro to ggplot [DC]           |
  | 26 | Wed-26-Oct |            |                    |                                    |
  | 27 | Fri-28-Oct |            |                    |                                    |
  |----+------------+------------+--------------------+------------------------------------|
  | 28 | Mon-31-Oct | Test 10    | 3.3 Anomalies      | 12. Building web apps w/shiny [DC] |
  | 29 | Wed-02-Nov |            |                    | 3rd Sprint Review                  |
  | 30 | Fri-04-Nov |            |                    |                                    |
  |----+------------+------------+--------------------+------------------------------------|
  | 31 | Mon-07-Nov | Test 11    | 3.4 Relationships  | 13. Introduction to Tableau [DC]   |
  | 32 | Wed-09-Nov |            |                    |                                    |
  | 33 | Fri-11-Nov |            |                    |                                    |
  |----+------------+------------+--------------------+------------------------------------|
  | 34 | Mon-14-Nov | Test 12    | 4 External data    | 14. External data                  |
  | 35 | Wed-16-Nov |            |                    |                                    |
  | 36 | Fri-18-Nov |            |                    |                                    |
  |----+------------+------------+--------------------+------------------------------------|
  | 37 | Mon-21-Nov | Test 13    | 4.74. RSQLite      | 15. RSQLite                        |
  |----+------------+------------+--------------------+------------------------------------|
